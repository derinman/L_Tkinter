...
class Game(tk.Tk):
    def __init__(self):
        ...
        self.right_frame = tk.Frame(self, width=300, height=800,borderwidth=10, relief="ridge")
        self.right_frame.pack_propagate(0)

        self.help_var = tk.StringVar(self.right_frame)
        self.help_var.set("Try Clicking Something")

        self.help_box = tk.Label(self.right_frame, textvar=self.help_var, background="black", foreground="white", padx=10, pady=20,borderwidth=10, relief="ridge")
